<form method="POST">
<title>END USERS - SEARCH MOVIE DB BY MOVIE Studios</title>
<h1>END USER  - SEARCH MOVIE DB BY MOVIE Studios </h1>
<h2>AVINASH SHAH 2018 Spring - IT 635102 </h2>
<input type="TEXT" name="search" />
<input type="SUBMIT" name="submit" Value="Search For All Movie Info by Movie Studio" />
</form>
...
moviegenre.movie_id, movie.movie_title, movieyear.movie_year, moviedirector.movie_director, moviestudio.movie_studio, 
movieimdb.movie_imdb, moviegenre.movie_genre, moviefileinfo.movie_source, moviefileinfo.movie_filename, moviefileinfo.movie_gb
FROM   moviegenre
INNER JOIN movie
...
WHERE moviestudio.movie_studio LIKE '%$search%'");
