<form method="POST">
<title>END USERS - SEARCH MOVIE DB BY MOVIE Genres</title>
<h1>END USER  - SEARCH MOVIE DB BY MOVIE Genres </h1>
<h2>AVINASH SHAH 2018 Spring - IT 635102 </h2>
<input type="TEXT" name="search" />
<input type="SUBMIT" name="submit" Value="Search For All Movies by Movie Genre" />
</form>
...
WHERE moviegenre.movie_genre LIKE '%$search%'");
