<form method="POST">
<title>Admin USERS - SEARCH MOVIE DB BY MOVIE Title</title>
<h1>Admin USER  - SEARCH MOVIE DB BY MOVIE Title </h1>
...
echo "<br>";
echo <<<HTML
<a href="http://ec2-18-218-36-211.us-east-2.compute.amazonaws.com/a/searchmoviesbyid.php">Search Movie Info with Movid id # </a>
HTML;
echo "<br>";
echo "<br>";
echo <<<HTML
